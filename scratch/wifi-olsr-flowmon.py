...
def main(argv):
    ...
    ipv4Addresses.SetBase(ns.network.Ipv4Address("10.0.0.0"), ns.network.Ipv4Mask("255.255.0.0"))
    ...
    for i, node in enumerate(nodes):
        ...
        app.Start(ns.core.Seconds(urv.GetValue(10, 20)))
